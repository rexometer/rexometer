...
<html>
    <head>
        ...
        <title>RExometer - <?php echo $route->controller.' '.$route->action.' '.$route->subaction; ?></title>
        ...
        <link href="<?php echo $path; ?>Theme/<?php echo $theme; ?>/rexo.css" rel="stylesheet">
...
?>
        ...
        <div id="footer">
            <a href="https://rexometer.com">rexometer.com</a> | 
            <?php echo _('Software: '); ?>
            <a href="http://github.com/emoncms/emoncms">emoncms</a>
